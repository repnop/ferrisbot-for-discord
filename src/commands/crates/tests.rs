...
impl super::DocsClient for MockDocsClient {
    async fn page_exists(&self, url: &str) -> bool {
        match url {
            ...
            _ if url.starts_with("https://docs.rs/serde-json/latest/serde_json/non/existent") => false,
...
async fn path_to_doc_url_self_ty() {
    test_path_to_doc_url("Self", "https://doc.rust-lang.org/stable/std/keyword.SelfTy.html").await;
}

#[tokio::test]
async fn path_to_doc_url_std_primitive() {
    test_path_to_doc_url("f128", "https://doc.rust-lang.org/nightly/std/primitive.f128.html").await;
}
...
async fn path_to_doc_url_stable_guessed_const() {
    test_path_to_doc_url("std::char::MAX", "https://doc.rust-lang.org/stable/std/char/constant.MAX.html").await;
}
...
async fn path_to_doc_url_guessed_fn() {
    test_path_to_doc_url("serde-json::to_string", "https://docs.rs/serde-json/latest/serde_json/fn.to_string.html")
        .await;
}

#[tokio::test]
async fn path_to_doc_url_guessed_mod() {
    test_path_to_doc_url("serde-json::value", "https://docs.rs/serde-json/latest/serde_json/value/index.html").await;
}
