...
use super::{
    ...
    util::{
        format_play_eval_stderr, generic_help, maybe_wrapped, parse_flags, send_reply, stub_message, GenericHelp,
        ResultHandling,
    },
};
...
pub async fn play(ctx: Context<'_>, flags: poise::KeyValueArgs, code: poise::CodeBlock) -> Result<(), Error> {
...
pub async fn playwarn(ctx: Context<'_>, flags: poise::KeyValueArgs, code: poise::CodeBlock) -> Result<(), Error> {
...
pub async fn eval(ctx: Context<'_>, flags: poise::KeyValueArgs, code: poise::CodeBlock) -> Result<(), Error> {
